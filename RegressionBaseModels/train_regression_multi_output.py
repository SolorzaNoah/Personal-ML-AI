...
model.save('model_regression_multi_output.pkl')

# Plot the training loss
plt.plot(model.training_loss)
plt.title('Training Loss for Multi-Output Regression Model')
plt.xlabel('Step')
plt.ylabel('Loss')
plt.savefig('training_loss_regression_multi_output.png')
plt.close()
