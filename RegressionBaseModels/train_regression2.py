...
X = irisDataset.data  # All features
y = irisDataset.target

XTrain, XTest, yTrain, yTest = train_test_split(X[:, [2, 3]], X[:, 0], test_size=0.1)
...
model.save('model_regression2.pkl')

# Plot the training loss
plt.plot(model.training_loss)
plt.title('Training Loss for Regression Model 2')
plt.xlabel('Step')
plt.ylabel('Loss')
